 ...
 * In the case of a triple store that is accessed via a SPARQL endpoint then the RdfRepository decalres at least a data implementation, and optionally a model implementation.
